...
)
{
	...
	hdata[0].u.x = AKM_HDATA_CONVERTER(mag[0], asa->u.x) / prms->fv_hs.u.x;
	hdata[0].u.y = AKM_HDATA_CONVERTER(mag[1], asa->u.y) / prms->fv_hs.u.x;
	hdata[0].u.z = AKM_HDATA_CONVERTER(mag[2], asa->u.z) / prms->fv_hs.u.x;
